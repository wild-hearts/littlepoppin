...
const SECTIONS = [
  ...
  { id: 'festive', title: '🎄 Festive Magic',
...
const setCards = setItems.map(it => `          <article class="print-card print-card--set">
            <div class="print-card__img print-card__img--set"><img src="${it.preview}" alt="${it.title} — gallery set of three magical art prints" loading="lazy" /></div>
            <div class="print-card__body">
...
const setsSection = setItems.length ? `    <section class="prints prints--sets">
      <div class="container">
